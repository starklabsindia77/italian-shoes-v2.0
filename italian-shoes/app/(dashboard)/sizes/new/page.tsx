    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground">Create a global size (visible on all products).</p>
          </div>
        </div>
      ...
      <Card className="rounded-2xl">
        ...
        <CardContent className="grid gap-6 md:grid-cols-2">
          ...
          <Field label="Region">
            <Select value={form.region} onValueChange={(v: Region) => setForm((f) => ({ ...f, region: v }))}>
          ...
          <Field label="EU Equivalent (optional)">
            <Input
              ...
              onChange={(e) => setForm((f) => ({ ...f, euEquivalent: e.target.value }))}
            />
          </Field>
          <Field label="UK Equivalent (optional)">
            <Input
              ...
              onChange={(e) => setForm((f) => ({ ...f, ukEquivalent: e.target.value }))}
            />
          </Field>
